...
public:
	virtual HRESULT CreateVertexData() = 0;
	virtual HRESULT CreateIndexData() = 0;
	bool Create(ID3D11Device* device, ID3D11DeviceContext* context, std::wstring vs_file_path, std::string vs_func_name, std::wstring ps_file_path, std::string ps_func_name);
