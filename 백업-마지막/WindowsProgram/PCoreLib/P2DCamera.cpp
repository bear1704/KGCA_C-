...
void P2DCamera::MoveCamera()
{
	...
	RECT INT_center_rect = { center_rect_.left, center_rect_.top, center_rect_.right, center_rect_.bottom };
...
bool P2DCamera::Init()
{
	...
	camera_object_rect_ = { center_rect_.left,center_rect_.top , (float)g_rectangle_client.right, (float)g_rectangle_client.bottom };
