...
bool  Sample::Render()
{
	...
	RECT pc1 = P2DCamera::GetInstance().WorldToGamescreenRECT(player_collision_rect);
	...
	SetROP2(g_handle_off_screenDC, R2_NOTXORPEN);
	RECT colrect = P2DCamera::GetInstance().WorldToGamescreenRECT(cam_center_pos_rect);
